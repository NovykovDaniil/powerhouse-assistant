...
class NoteBook(UserDict):
    ...
    def del_note(self, id_note: int):
        yes_no = input(
            f"Are you sure you want to delete the note ID:{id_note}? (Yes/not) "
        )
        if yes_no == "Yes":
            del self[id_note]
    ...
    def sort_by_tags(self, tag_sorted=True):
        return self.show_all(self, tag_sorted=True)
